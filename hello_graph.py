...
bottom_left = (0.1321315305706198, 0.1131595236316314, -0.11392253122347966, 1.6292752851180379, 0.041292529477768534, 0.04257424620303891)
...
side_bottom = (0.09034984206608578, 0.002978369660784703, -0.06242151328692695, 1.2794475247155692, -1.1572609875282505, -1.140752256157648)
...
add_edge(G, side_bottom, side_top)
...
path = nx.dijkstra_path(G, side_bottom, bottom_right)
print(path)

rob.movels(path,acc=0.1,vel=0.1)
